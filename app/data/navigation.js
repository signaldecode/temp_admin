...
export const navigationItems = [
  ...
  },
  {
    ...
    children: [
      { id: 'display-main', label: '메인 전시', to: '/admin/display' },
      { id: 'design-header', label: '헤더 관리', to: '/admin/design/header' },
      { id: 'design-banners', label: '배너 관리', to: '/admin/design/banners' },
      { id: 'design-popups', label: '팝업 관리', to: '/admin/design/popups' },
    ],
  },
  {
    id: 'contents',
  ...
  // },
  {
    ...
    children: [
      ...
      { id: 'settings-profile', label: '내 계정', to: '/admin/settings/profile' },
    ],
  },
]
